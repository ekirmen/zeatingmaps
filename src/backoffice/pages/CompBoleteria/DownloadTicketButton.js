  ...
  const testSimpleDownload = async () => {
    ...
    try {
      ...
      if (error.message.includes('Failed to fetch')) {
        console.error(
          'Œ [SIMPLE-TEST] Error de red detectado - posible problema de variables de entorno en Vercel'
        );
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (err.message.includes('Failed to fetch')) {
        console.error(
          'Œ [DOWNLOAD] Error de red detectado - posible problema de variables de entorno en Vercel'
        );
        message.error('Œ Error de red - verificar variables de entorno en Vercel');
        ...
        console.error(
          'Œ [DOWNLOAD] Servidor devuelve HTML - variables de entorno no configuradas en Vercel'
        );
      ...
      {showDebugButtons && (
        <Space direction="vertical" style={{ width: '100%' }}>
          ...
          >
            ...
            <br />
            -¢ Descarga principal con autenticaci³n
            <br />
