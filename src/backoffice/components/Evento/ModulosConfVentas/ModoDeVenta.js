...
const ModoDeVenta = ({ eventoData, setEventoData }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <p>
        Selecciona el método que mejor cuadra con tu tipo de venta. Si tu evento es numerado o no
        numerado, si tienes diferentes fechas o incluso dependiendo de tu tipo de usuario, uno de
        los modos debe encajar mejor con tus necesidades de venta.
      </p>
      <div className="flex flex-wrap items-stretch gap-3">
        ...
        >
          <GridIcon
            width={28}
            height={28}
            className={`mb-1 ${eventoData.modoVenta === 'grid' ? 'opacity-100' : 'opacity-70'}`}
          />
          <h4
            className={`font-semibold ${eventoData.modoVenta === 'grid' ? 'text-blue-700' : 'text-gray-700'}`}
          >
            Modo Grid
          </h4>
        ...
        >
          <MultiStepIcon
            width={28}
            height={28}
            className={`mb-1 ${eventoData.modoVenta === 'multi-step' ? 'opacity-100' : 'opacity-70'}`}
          />
          <h4
            className={`font-semibold ${eventoData.modoVenta === 'multi-step' ? 'text-blue-700' : 'text-gray-700'}`}
          >
            Modo Multi-Step
          </h4>
          <p className="text-[11px] text-center text-gray-600 max-w-[160px]">
        ...
        >
          <MapIcon
            width={28}
            height={28}
            className={`mb-1 ${eventoData.modoVenta === 'mapa' ? 'opacity-100' : 'opacity-70'}`}
          />
          <h4
            className={`font-semibold ${eventoData.modoVenta === 'mapa' ? 'text-blue-700' : 'text-gray-700'}`}
          >
            Modo Mapa
          </h4>
          <p className="text-[11px] text-center text-gray-600 max-w-[160px]">
            La selección de asientos se muestra antes que la de los tipos de precio.
          </p>
        </button>
        <button
          type="button"
        ...
        >
          <AccreditationIcon
            width={28}
            height={28}
            className={`mb-1 ${eventoData.modoVenta === 'acreditacion' ? 'opacity-100' : 'opacity-70'}`}
          />
          <h4
            className={`font-semibold ${eventoData.modoVenta === 'acreditacion' ? 'text-blue-700' : 'text-gray-700'}`}
          >
