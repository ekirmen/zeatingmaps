...
const CampaignButtonGenerator = ({ campaignId, onButtonGenerated }) => {
            ...
            channels: [
              {
                id: '8',
                name: 'Marca blanca 1',
                url: 'https://kreatickets.pagatusboletos.com/tickets/',
              },
  ...
  const getButtonTypeLabel = () => {
    switch (buttonType) {
      ...
      case '1':
        return 'Botón de invitación individual';
      case '2':
        return 'Renovación de abono de temporada';
      case '3':
      ...
      {campaign && (
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700">Tipo de botón</label>
          ...
          {(selectedEvent || customUrl || buttonText) && (
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="mt-2 text-xs text-gray-600">
                ...
                {selectedEvent && (
                  <p>Evento: {campaign.events.find(e => e.id === selectedEvent)?.name}</p>
                )}
                {selectedChannel && (
                  <p>Canal: {campaign.channels.find(c => c.id === selectedChannel)?.name}</p>
                )}
