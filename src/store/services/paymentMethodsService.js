...
export const getActivePaymentMethods = async (tenantId = null, eventId = null) => {
  try {
    const currentTenantId = tenantId || await resolveTenantId();
...
export const getAvailablePaymentMethodIds = async (tenantId = null) => {
  try {
    const methods = await getActivePaymentMethods(tenantId);
