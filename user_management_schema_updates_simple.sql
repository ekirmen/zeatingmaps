-- 🚀 Actualización del Esquema para Gestión Avanzada de Usuarios (VERSIÓN SIMPLIFICADA)
-- Este script se adapta a la estructura real de la tabla profiles sin conflictos
