-- =====================================================
-- SCRIPT SQL CORREGIDO - OPTIMIZACIÓN DE BASE DE DATOS
-- =====================================================

-- 1. VERIFICAR ESTRUCTURA DE TABLAS EXISTENTES
-- =====================================================

-- Verificar si payment_transactions tiene las columnas necesarias
DO $$
BEGIN
...
-- 3. MIGRAR DATOS DE PAYMENTS A PAYMENT_TRANSACTIONS
-- =====================================================

-- Verificar si la tabla payments existe antes de migrar
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'payments') THEN
        ...
        RAISE NOTICE 'Datos migrados desde payments a payment_transactions';
    ELSE
...
-- 7. MIGRAR DATOS DE MÉTODOS DE PAGO
-- =====================================================
...
-- Migrar configuraciones específicas desde payment_gateway_configs si existe
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'payment_gateway_configs') THEN
        ...
        RAISE NOTICE 'Configuraciones migradas desde payment_gateway_configs';
    ELSE
        RAISE NOTICE 'Tabla payment_gateway_configs no existe, saltando migración de configuraciones';
    END IF;
END $$;
