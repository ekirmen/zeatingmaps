-- Script para crear las funciones RPC que faltan
-- Ejecutar en Supabase SQL Editor

-- 1. Función para bloquear asiento atómicamente
...
-- 2. Función para desbloquear asiento
...
-- 3. Función para verificar si un asiento está disponible
