/*
Apply conservative wraps only to candidates whose first return is within the first LINE_THRESHOLD lines.
This script will create .bak backups and overwrite the files.
*/
const fs = require('fs');
