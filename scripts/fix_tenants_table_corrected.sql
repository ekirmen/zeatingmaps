-- Script CORREGIDO para arreglar la tabla tenants y agregar políticas RLS
...
-- 7. Verificar estructura completa de la tabla tenants
SELECT 
    column_name,
    data_type,
    is_nullable,
...
BEGIN
    ...
    RAISE NOTICE '📊 Verifica que la inserción de tenants funciona ahora';
END $$;
