-- 🚀 Crear Funciones con Admin (Sin RLS)
-- Este script crea funciones usando el cliente admin para evitar RLS
...
-- =====================================================
-- CREAR FUNCIONES DIRECTAMENTE (SIN RLS)
-- =====================================================

-- Crear función para "Evento de Prueba ZeatingMaps" - Sala Principal
...
-- Crear función para "Evento de Prueba ZeatingMaps" - Sala VIP
INSERT INTO funciones (
    evento, 
    sala, 
    fecha_celebracion, 
