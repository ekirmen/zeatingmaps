-- Diagnóstico correcto de las funciones 10 y 11
...
-- 5. Verificar las zonas (sala_id es text, necesitamos convertir)
...
FROM zonas z
WHERE z.sala_id IN (
    SELECT DISTINCT sala::text 
    FROM funciones 
    WHERE id IN (10, 11)
);

-- 6. Verificar las plantillas (sin descripcion)
