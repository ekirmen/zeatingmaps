-- Script para crear las 8 tablas faltantes
-- =====================================================
...
-- 5. Crear tabla usuarios (si no existe users)
...
INSERT INTO boleteria (evento_id, funcion_id, nombre, descripcion, precio, stock_disponible) VALUES 
    (gen_random_uuid(), gen_random_uuid(), 'Entrada General', 'Entrada general para el evento', 50.00, 100),
    (gen_random_uuid(), gen_random_uuid(), 'Entrada VIP', 'Entrada VIP con beneficios especiales', 100.00, 50)
ON CONFLICT DO NOTHING;
