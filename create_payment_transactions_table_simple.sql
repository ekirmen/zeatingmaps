-- Script para crear la tabla payment_transactions (versión simplificada)
...
-- 4. Crear políticas RLS simplificadas
...
-- 5. Crear función para updated_at (solo si no existe)
